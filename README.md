...
- Enter a career or learning goal
- Generate a structured multi-week roadmap
- Break large goals into smaller actionable milestones
- Present steps in a clear and user-friendly format
- Help users move from planning to execution
...
1. The user enters a goal, such as:
   - “Become a frontend developer in 3 months”
